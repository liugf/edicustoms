 ...
 */
package com.gavin.ediCustoms.resources.icons;
...
public interface ExampleIcons extends ImageBundle {
  ...
  AbstractImagePrototype preview();
  
  @Resource("printer.gif")
  AbstractImagePrototype printer();
  
  @Resource("leadIn.gif")
  AbstractImagePrototype leadIn();
  
  @Resource("refresh.gif")
  AbstractImagePrototype reflesh();
  
  @Resource("submit.gif")
  AbstractImagePrototype submit();
